...
# this should be public IP in central in this case
TARGET_CRDB_NODE=20.118.33.246
...
scp -i ${TARGET_REGION_PEM} $SOURCE_KEY_DIRECTORY/tls_user_key "adminuser@${TARGET_CRDB_NODE}:${TARGET_DIRECTORY}/client.jhaugland.key"
